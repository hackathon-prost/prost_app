...
<html lang="en">
<head>
    <title>Code coverage report for babel-plugin-react-intl/src/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">babel-plugin-react-intl/src</a> index.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">78.7% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>85/108</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">89.63% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>121/135</span>
      </div>
    </div>
    <p class="quiet">
...
&nbsp;
  function evaluatePath(path) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (evaluated.confident) {
      return evaluated.value;
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw path.buildCodeFrameError(</span>
      '[React Intl] Messages must be statically evaluate-able for extraction.'
    );
  }
&nbsp;
  function getMessageDescriptorKey(path) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (path.isIdentifier() || path.isJSXIdentifier()) {
      return path.node.name;
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return evaluatePath(path);</span>
  }
&nbsp;
...
&nbsp;
  function getICUMessageValue(messagePath, { isJSXSource = <span class="branch-0 cbranch-no" title="branch not covered" >false </span>} = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
...
<span class="cstat-no" title="statement not covered" >        throw messagePath.buildCodeFrameError(</span>
...
&nbsp;
  function evaluateMessageDescriptor(
    { ...descriptor },
    { isJSXSource = false, overrideIdFn } = <span class="branch-0 cbranch-no" title="branch not covered" >{}</span>
  ) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(id &amp;&amp; defaultMessage)) {
<span class="cstat-no" title="statement not covered" >      throw path.buildCodeFrameError(</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (messages.has(id)) {
      const existing = <span class="cstat-no" title="statement not covered" >messages.get(id);</span>
&nbsp;
...
&nbsp;
    if (opts.enforceDescriptions) {
      if (
        !description ||
        (typeof description === 'object' &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >Object.keys(description).length &lt; 1)</span>
      ) {
...
&nbsp;
      if (t.isIdentifier(property) &amp;&amp; property.node.name === 'formatMessage') {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (t.isIdentifier(objectProperty)) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (objectProperty.node.name === 'intl') {
            return true;
          }
        }
      }
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (opts.messagesDir &amp;&amp; descriptors.length &gt; 0) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (process.platform === 'win32') {
          const { name } = <span class="cstat-no" title="statement not covered" >p.parse(process.cwd());</span>
<span class="cstat-no" title="statement not covered" >          if (relativePath.includes(name)) {</span>
<span class="cstat-no" title="statement not covered" >            relativePath = relativePath.slice(</span>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (name.referencesImport(moduleSourceName, 'FormattedPlural')) {
          const warn = <span class="cstat-no" title="statement not covered" >file.log ? file.log.warn : console.warn;</span>
...
&nbsp;
        function assertObjectExpression(node) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!(node &amp;&amp; node.isObjectExpression())) {
<span class="cstat-no" title="statement not covered" >            throw path.buildCodeFrameError(</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri May 31 2019 20:55:46 GMT-0500 (GMT-05:00)
</div>
</div>
